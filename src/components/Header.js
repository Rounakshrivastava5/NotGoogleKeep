...
function Header(){
    return(
        ...
        <Paper style={{padding:"1px", display: "flex"}}  elevation={3}>
        
        <svg xmlns="http://www.w3.org/2000/svg" width="65" height="85" fill="currentColor" class="bi bi-file-code-fill" viewBox="0 0 16 16">
